<template>
  <div class="relative min-h-[80vh] flex items-center overflow-hidden">
    ...
    <<div class="absolute bottom-0 left-0 right-0 w-full z-20 leading-none translate-y-[1px]">
      <svg class="w-full h-16 text-white" preserveAspectRatio="none" viewBox="0 0 1440 120" fill="currentColor">
